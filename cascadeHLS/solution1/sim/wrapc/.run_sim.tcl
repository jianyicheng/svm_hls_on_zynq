...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "svm_classifier.autotvin.dat"
	set constFileTvOut       "svm_classifier.autotvout.dat"
	set constFileHdlTvIn     "svm_classifier.autohdltvin.dat"
	set constFileHdlTvOut    "svm_classifier.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
