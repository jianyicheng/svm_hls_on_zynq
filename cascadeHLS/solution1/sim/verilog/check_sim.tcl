...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.svm_classifier.autotvin_in_V.dat"
         "c.svm_classifier.autotvout_lp_count.dat"
         "c.svm_classifier.autotvout_hp_count.dat"
         "c.svm_classifier.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.svm_classifier.autotvout_lp_count.dat"
         "rtl.svm_classifier.autotvout_hp_count.dat"
         "rtl.svm_classifier.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
