...
`define AUTOTB_DUT      svm_classifier
`define AUTOTB_DUT_INST AESL_inst_svm_classifier
`define AUTOTB_TOP      apatb_svm_classifier_top
`define AUTOTB_LAT_RESULT_FILE "svm_classifier.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "svm_classifier.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_svm_classifier_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_in_V 1
`define AESL_DEPTH_lp_count 1
`define AESL_DEPTH_hp_count 1
`define AUTOTB_TVIN_in_V  "./c.svm_classifier.autotvin_in_V.dat"
`define AUTOTB_TVIN_in_V_out_wrapc  "./rtl.svm_classifier.autotvin_in_V.dat"
`define AUTOTB_TVOUT_lp_count  "./c.svm_classifier.autotvout_lp_count.dat"
`define AUTOTB_TVOUT_hp_count  "./c.svm_classifier.autotvout_hp_count.dat"
`define AUTOTB_TVOUT_ap_return  "./c.svm_classifier.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_lp_count_out_wrapc  "./impl_rtl.svm_classifier.autotvout_lp_count.dat"
`define AUTOTB_TVOUT_hp_count_out_wrapc  "./impl_rtl.svm_classifier.autotvout_hp_count.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.svm_classifier.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2000;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 120;
parameter LENGTH_in_V = 1;
parameter LENGTH_lp_count = 1;
parameter LENGTH_hp_count = 1;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .ap_rst_n(ap_rst_n),
    .hp_count(hp_count),
    .hp_count_ap_vld(hp_count_ap_vld));
...
reg AESL_REG_hp_count_ap_vld = 0;
// The signal of port hp_count
reg [31: 0] AESL_REG_hp_count = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset === 0)
        AESL_REG_hp_count = 0; 
    else if(hp_count_ap_vld) begin
        AESL_REG_hp_count <= hp_count;
        AESL_REG_hp_count_ap_vld <= 1;
    end
end 

initial begin : write_file_process_hp_count
    integer fp;
    integer fp_size;
    integer err;
    integer ret;
    ...
    integer rand;
    integer hp_count_count;
    reg [199:0] token;
    integer transaction_idx;
    reg [8 * 5:1] str;
    wait(AESL_reset === 1);
    fp = $fopen(`AUTOTB_TVOUT_hp_count_out_wrapc,"w");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_hp_count_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    while (transaction_idx != AUTOTB_TRANSACTION_NUM) begin
        ...
        if(AESL_REG_hp_count_ap_vld)  begin
          $fdisplay(fp,"0x%x", AESL_REG_hp_count);
        AESL_REG_hp_count_ap_vld = 0;
        end
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.svm_classifier.autotvout_hp_count.dat", "r");
    fp2 = $fopen("./impl_rtl.svm_classifier.autotvout_hp_count.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.svm_classifier.autotvout_hp_count.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.svm_classifier.autotvout_hp_count.dat\"!");
    else begin
        $display("Comparing rtl.svm_classifier.autotvout_hp_count.dat with impl_rtl.svm_classifier.autotvout_hp_count.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.svm_classifier.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.svm_classifier.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.svm_classifier.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.svm_classifier.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.svm_classifier.autotvout_ap_return.dat with impl_rtl.svm_classifier.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_lp_count;
reg [31:0] size_lp_count;
reg [31:0] size_lp_count_backup;
reg end_hp_count;
reg [31:0] size_hp_count;
reg [31:0] size_hp_count_backup;
reg end_ap_return;
...
reg dump_tvout_finish_lp_count;

initial begin : dump_tvout_runtime_sign_lp_count
    integer fp;
    dump_tvout_finish_lp_count = 0;
    fp = $fopen(`AUTOTB_TVOUT_lp_count_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_lp_count_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_lp_count_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_lp_count_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
