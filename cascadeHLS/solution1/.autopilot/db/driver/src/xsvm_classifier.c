...
u32 XSvm_classifier_Get_return(XSvm_classifier *InstancePtr) {
    ...
    Data = XSvm_classifier_ReadReg(InstancePtr->Axilites_BaseAddress, XSVM_CLASSIFIER_AXILITES_ADDR_AP_RETURN);
    return Data;
}
...
u32 XSvm_classifier_Get_lp_count(XSvm_classifier *InstancePtr) {
    ...
    Data = XSvm_classifier_ReadReg(InstancePtr->Axilites_BaseAddress, XSVM_CLASSIFIER_AXILITES_ADDR_LP_COUNT_DATA);
    return Data;
}
...
u32 XSvm_classifier_Get_lp_count_vld(XSvm_classifier *InstancePtr) {
    ...
    Data = XSvm_classifier_ReadReg(InstancePtr->Axilites_BaseAddress, XSVM_CLASSIFIER_AXILITES_ADDR_LP_COUNT_CTRL);
    return Data & 0x1;
}
