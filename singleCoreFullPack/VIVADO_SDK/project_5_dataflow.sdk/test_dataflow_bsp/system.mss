...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles  -mfpu=neon -ftree-vectorize -mvectorize-with-neon-quad -mfloat-abi=softfp
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = svm_classifier
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = svm_classifier_0
END
