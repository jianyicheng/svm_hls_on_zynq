...
set Library     "hls"
set IPName      "svm_classifier"
set Version     "1.0"
set DisplayName "Svm_classifier"
set Revision    "1803112035"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "svm_classifier"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 in_V_1 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 31 to 0 Data signal of in_V"}}} {0x14 in_V_2 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 63 to 32 Data signal of in_V"}}} {0x18 in_V_3 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 95 to 64 Data signal of in_V"}}} {0x1c in_V_4 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 127 to 96 Data signal of in_V"}}} {0x20 in_V_5 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 159 to 128 Data signal of in_V"}}} {0x24 in_V_6 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 191 to 160 Data signal of in_V"}}} {0x28 in_V_7 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 223 to 192 Data signal of in_V"}}} {0x2c in_V_8 W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 255 to 224 Data signal of in_V"}}} {0x34 out_r R 0x0 "Data signal of out_r" {{0 1 out_r R 0 "Bit 0 to 0 Data signal of out_r"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 out_r_ctrl R 0x0 "Control signal of out_r" {{0 1 out_r_ap_vld R 0 "Control signal out_r_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 90 II x}
...
set enable_xo_gen 0
set kernel_files {H:/MATLAB/MATLAB_2/MATLAB/svm_classifier_prj_v6.2_Ch18/svm_classifier_prj_v6.2_Ch18/svm_classifier_prj/svm_classifier.cpp H:/MATLAB/MATLAB_2/MATLAB/svm_classifier_prj_v6.2_Ch18/svm_classifier_prj_v6.2_Ch18/svm_classifier_prj/getTanh.cpp}
if {$enable_xo_gen} {
