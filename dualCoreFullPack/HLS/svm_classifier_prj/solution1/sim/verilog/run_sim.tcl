...
if {[file isfile svm_classifier.autotvin.dat]} {
	file delete -force svm_classifier.autotvin.dat
}

if {[file isfile svm_classifier.autotvout.dat]} {
	file delete -force svm_classifier.autotvout.dat
}
