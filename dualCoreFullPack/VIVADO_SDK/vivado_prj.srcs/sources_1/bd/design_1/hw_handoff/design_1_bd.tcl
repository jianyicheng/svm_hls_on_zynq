...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: svm_classifier_0, and set properties
  set svm_classifier_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:svm_classifier:1.0 svm_classifier_0 ]

  # Create instance: svm_classifier_1, and set properties
  set svm_classifier_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:svm_classifier:1.0 svm_classifier_1 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_1_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph_1/M00_AXI] [get_bd_intf_pins svm_classifier_1/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins svm_classifier_0/s_axi_AXILiteS]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/ACLK] [get_bd_pins processing_system7_0_axi_periph_1/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins svm_classifier_0/ap_clk] [get_bd_pins svm_classifier_1/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins svm_classifier_0/ap_rst_n] [get_bd_pins svm_classifier_1/ap_rst_n]
  connect_bd_net -net svm_classifier_0_interrupt [get_bd_pins svm_classifier_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net svm_classifier_1_interrupt [get_bd_pins svm_classifier_1/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs svm_classifier_0/s_axi_AXILiteS/Reg] SEG_svm_classifier_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs svm_classifier_1/s_axi_AXILiteS/Reg] SEG_svm_classifier_1_Reg
...
preplace inst svm_classifier_0 -pg 1 -lvl 2 -y -60 -defaultsOSRD
preplace inst svm_classifier_1 -pg 1 -lvl 3 -y 90 -defaultsOSRD -resize 240 100
preplace inst processing_system7_0 -pg 1 -lvl 1 -y -160 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ -240 N -240 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -220 N -220 N
levelinfo -pg 1 -150 40 370 660 820 -top -280 -bot 170
",
}
